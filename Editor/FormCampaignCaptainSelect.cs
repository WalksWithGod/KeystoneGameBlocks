...
{
    /// <summary>
    /// Description of FormCampaignCaptainSelect.
    /// </summary>
    public partial class FormCampaignCaptainSelect : UserControl, IWizardPage
	{
		private bool mBusy;
		private bool mPageValid;
		private string mMessage;
		
		public FormCampaignCaptainSelect(Settings.Initialization ini)
		{
			//
