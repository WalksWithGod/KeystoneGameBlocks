...
namespace KeyEdit.Scripting
{
    ...
    /// <summary>
    /// For the purposes of providing syntax highlighting for assemblies referenced in the user's script
    /// (e.g. Keystone.Types.Vector3d) those assemblies should be added to a list of assemblies that
    /// are referenceable to the script.  
    /// </summary>
