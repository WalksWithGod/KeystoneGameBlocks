...
{
    /// <summary>
    /// A stand alone command line server.  The server can be logged into from a local administration client to receive
    /// statistics.
    /// </summary>
    class Application
    {
        static void Main(string[] args)
        {
            ...
            servicesToRun = new KeyServiceBase[] { new KeyGameService() };
