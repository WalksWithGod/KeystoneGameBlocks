...
vertexOutput Transform(vertexInput IN) 
{
    ...
    OUT.texCoordDiffuse.x = IN.texCoordDiffuse.x*textureScaleX+planetScrollX;
    OUT.texCoordDiffuse.y = IN.texCoordDiffuse.y*textureScaleY+planetScrollY;
...
float4 PixelShader(vertexOutput IN): COLOR
{
  ...
  return IN.diffAmbColor * selectionTexture;
}
