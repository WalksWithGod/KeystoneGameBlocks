...
vertexPulseOutput VS_TransformPulse(vertexInput IN) 
{
    ...
    OUT.texCoordNoise1 = (IN.texCoordDiffuse * noiseScale) + time/10%2;
    OUT.texCoordNoise2 = (IN.texCoordDiffuse * noiseScale) - time/10%2;
...
float4 PS_Pulse( vertexPulseOutput IN): COLOR
{
  ...
  return (IN.diffAmbColor * float4(diffuseTexture.rgb,1)) + lerp(0,(noise1 * noise2),diffuseTexture.a) + IN.specCol;
}
