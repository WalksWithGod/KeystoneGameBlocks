...
float scale2 = 406801596e5; // 40680159610000; // 162720638440000; //625000000; // 1000000; //radius of planet squared // Hypno todo: this i need to update
...
VertexShaderOutput VertexShaderFunction(VertexShaderInput input)
{
	...
	float3 dst = LightPosition;
    	float3 Ray = LightPosition-worldPosition.xyz;
    	float lr = length(Ray);
    	float ld = length(dst);
    	Ray=normalize(Ray);
	float B = dot(dst,Ray);
