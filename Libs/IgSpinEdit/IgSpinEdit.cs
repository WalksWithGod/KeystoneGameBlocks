...
namespace IgNS.Controls
{
    ...
    public partial class IgSpinEdit : UserControl, ISupportInitialize
    {
        ...
        {
            initializing = false;
            Value = mValue; // to correct possibly erroneous display of value caused by ValAsInt set during construction
        ...
        public string FormatString
        {
            ...
            set {
                ...
                {
                    if (valAsInt) 
                        edVal.Text = string.Format(value, (long)mValue);
                    else edVal.Text = string.Format(value, mValue);
                    formatStr = value;
                }
                catch { 
                    formatStr = "{0}";
                    edVal.Text = string.Format(formatStr, mValue);
                }
            }
        }
        /// <summary>
        ...
        public double Value
        {
            ...
            set
            {
                ...
                {
                    if (valAsInt)
                        edVal.Text = string.Format(formatStr, (long)mValue);
                    else edVal.Text = string.Format(formatStr, mValue);
                }
                catch
                {
                    formatStr = "{0}";
