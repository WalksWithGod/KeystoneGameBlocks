...
{
    [ToolboxBitmap(typeof(Open.Diagramming.Forms.Diagram), "Resource.diagram.bmp")]
    public class Diagram: View
    {
        ...
        public Diagram(): base()
        {
            ...
            Render = new ControlRender(Paging); //Replace the render instance with a control render instance
            Paging.Render = Render;
        ...
        protected override void OnDragOver(DragEventArgs drgevent)
        {
            ...
            if (DragElement != null)
            {
                ...
                ControlRender.DecorationPath = DragElement.GetPath();
        ...
        protected override void OnDragEnter(DragEventArgs drgevent)
        {
            ...
            foreach (String str in drgevent.Data.GetFormats())
            {
                ...
                type = null;
                type = global::Open.Diagramming.Serialization.Serialize.ResolveType(str);
