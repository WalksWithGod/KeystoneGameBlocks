...
namespace Open.Diagramming.Forms
{
    ...
    public partial class View: UserControl, IView
    {
        ...
        public View()
        {
            ...
            Render.RenderDiagram(new Rectangle(0, 0, this.Width, this.Height));
		...
		public new System.Drawing.Image BackgroundImage
		{
			...
			set
			{
                ...
                Render.Layers = Model.Layers;
                Render.Elements = Model.Elements;
				Render.RenderDiagram(_pageRect);
		...
		private void InvalidateImplementation(Rectangle rectangle)
		{
			...
			if (Render != null)
			{
                ...
                Render.Layers = Model.Layers;
                Render.Elements = Model.Elements;
				Render.RenderDiagram(rectangle);
				DrawDiagram(_controlRect);
			}
		}
		...
		private void SetPagedSettings()
		{
            if (Paging.Enabled) 
			{
                ...
                SizeF size = Geometry.GetPaperSize(DiagramUnit.Pixel, Open.Diagramming.Printing.PaperSizes.Iso.A4, g);
