...
namespace Open.Diagramming
{
	...
	sealed public class Singleton	
	{
		...
		private SizeF _defaultSize = new SizeF(100, 60);
		...
		public Cursor LoadCursor(string resource)
		{
			...
			{
				Cursor cursor = new Cursor(typeof(Open.Diagramming.Singleton), resource);
		...
		private void CreateDefaultHandlePath()
		{
			...
			//_defaultHandlePath.AddEllipse(0,0,6,6);
			//_defaultHandlePath.AddRectangle(new Rectangle(0,0,6,6));
		...
		{
            _selectionPen = new Pen(Color.FromArgb(160, Color.FromArgb(10, 36, 106)), -1);
		}
		...
		{
			_selectionRotatePen = new Pen(Color.FromArgb(160,Color.FromArgb(10,36,106)),-1);
		}
		...
		{
			_selectionFillBrush = new SolidBrush(Color.FromArgb(4,Color.FromArgb(10,36,106)));
		}

		private void CreateSelectionRotateBrush()
		{
			_selectionRotateBrush = new SolidBrush(Color.FromArgb(24,Color.FromArgb(10,36,106)));
		}
		...
		private void CreateSelectionHatchPen()
		{
			...
			//_selectionHatchPen = new Pen(brush,6);
            _selectionHatchPen = new Pen(Color.FromArgb(144, Color.FromArgb(10, 36, 106)), 1);
            _selectionHatchPen.DashStyle = DashStyle.Dot;
		}

		private void CreateActionPen()
		{
			_actionPen = new Pen(Color.FromArgb(128,Color.FromArgb(10,36,106)),1);
		}

		private void CreateActionBrush()
		{
			_actionBrush = new SolidBrush(Color.FromArgb(32,Color.FromArgb(10,36,106)));
		}

		private void CreateHighlightPen()
		{
			//_highlightPen = new Pen(Color.FromArgb(64,Color.FromArgb(10,36,106)),5);
            _highlightPen = new Pen(Color.FromArgb(64, SystemColors.Highlight));
			_highlightPen.DashStyle = DashStyle.Solid;
            _highlightPen.Width = 5;
			_highlightPen.Alignment = PenAlignment.Center;
		}

		private void CreateVectorPen()
		{
			//_vectorPen = new Pen(Color.FromArgb(96,Color.FromArgb(10,36,106)),1);
            //_vectorPen = new Pen(Color.FromArgb(96, SystemColors.Highlight));
            //_vectorPen.DashStyle = DashStyle.Solid;
            //_vectorPen.Width = 2;
            //_vectorPen.Alignment = PenAlignment.Center;
            _vectorPen = new Pen(Color.FromArgb(144, Color.FromArgb(10, 36, 106)), 1);
            _vectorPen.DashStyle = DashStyle.Dot;
		}

		private void CreateHighlightBrush()
		{
			//_highlightBrush = new SolidBrush(Color.FromArgb(32,Color.FromArgb(10,36,106)));
        ...
        private Theme CreateTheme(Themes themeType)
        {
            ...
            if (themeType == Open.Diagramming.Themes.LightBlue)
            {
                theme.BorderWidth = 2;
                theme.GradientColor = Color.FromArgb(192, 145, 186, 222);
                theme.BorderColor = Color.FromArgb(145, 186, 222);// 132, 169, 202
            }
