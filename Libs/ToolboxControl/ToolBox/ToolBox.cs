...
//           07.29.2012 - [Hypnotron] Replaced Collections.cs with Generic Lists.
//
...
namespace Silver.UI
{
    ...
    public class ToolBox : UserControl
    {
        ...
        private List<ToolBoxTab> _toolBoxTabs        = null;
        ...
        private void Initialize()
        {
            ...
            AllowDrop       = true;
            _toolBoxTabs = new List<ToolBoxTab>();
