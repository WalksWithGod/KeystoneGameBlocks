...
public class Host
{
    ...
    static void TestFastInvoking(int numOfLoops, AsmHelper script, object instance)
    {
        ...
        //option for invoking scrips methods. AsmHelper can cache dynamically emmited method 
    ...
    static void TestDelegates(int numOfLoops, FastInvokeDelegate fastInvoker, object instance)
    {
        ...
        //invoker (delegate) which can be used bu the host application to invoke script methods without AsmHelper.
        //
