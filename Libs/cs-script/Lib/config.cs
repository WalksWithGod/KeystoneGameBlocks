...
namespace Config
{
    public class ConfigForm : Form
    {
        ...
        private void Init()
        {
            ...
            int pos = engineAsmName.IndexOf("Version=");
            if (pos != -1)
            {
                textBox3.Text = engineAsmName.Substring(pos + "Version=".Length).Split(",".ToCharArray())[0];
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox4.Size = new System.Drawing.Size(419, 209);
            ...
            this.advancedShellEx.Size = new System.Drawing.Size(193, 17);
            ...
            this.configureShellExt.Location = new System.Drawing.Point(236, 7);
            ...
            this.repareBtn.Location = new System.Drawing.Point(259, 44);
            ...
            this.toolTip1.SetToolTip(this.repareBtn, "Repare .cs file association");
            this.repareBtn.Visible = false;
            ...
            this.deactivateBtn.Location = new System.Drawing.Point(337, 44);
        ...
        static public void Main(string[] args)
        {
            ...
            engineAsmName = Assembly.GetCallingAssembly().FullName; //name should be obtained here (it warranties that the calling assembly is the script engine but not the config.csc)
        ...
        private void ConfigForm_Load(object sender, EventArgs e)
        {
            ...
            configForm.baseDirectory = Path.Combine(CSScriptInstaller.GetEnvironmentVariable("CSSCRIPT_DIR"), @"Lib\ShellExtensions\CS-Script");
    ...
    class CSScriptInstaller
    {
        ...
        public static bool IsComShellExtInstalled()
        {
            ...
            {
                //using (RegistryKey regKey = Registry.ClassesRoot.OpenSubKey(@"CsScript\shellex\ContextMenuHandlers\Dynamic Context Menu"))
                //	return regKey != null;
        ...
        public static string comShellEtxDLL32
        {
            get
            {
                if (GetEnvironmentVariable("CSSCRIPT_DIR") != null)
                    return Path.Combine(GetEnvironmentVariable("CSSCRIPT_DIR"), @"Lib\ShellExtensions\CS-Script\ShellExt.cs.{25D84CB0-7345-11D3-A4A1-0080C8ECFED4}.dll");
                else
                    return "";
            }
        }
        public static string comShellEtxDLL64
        {
            ...
            {
                if (GetEnvironmentVariable("CSSCRIPT_DIR") != null)
                    return Path.Combine(GetEnvironmentVariable("CSSCRIPT_DIR"), @"Lib\ShellExtensions\CS-Script\ShellExt64.cs.{25D84CB0-7345-11D3-A4A1-0080C8ECFED4}.dll");
                else
                    return "";
            }
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (DialogResult.Yes == response)
                    {
                        if (Directory.Exists(Environment.ExpandEnvironmentVariables(@"%windir%\SysWOW64")))
                        {
                            RunApp(Environment.ExpandEnvironmentVariables(@"%windir%\SysWOW64\regsvr32.exe"), (silent ? "/s /u \"" : "/u \"") + comShellEtxDLL32 + "\"");
                            RunApp(Environment.ExpandEnvironmentVariables(@"%windir%\System32\regsvr32.exe"), (silent ? "/s /u \"" : "/u \"") + comShellEtxDLL64 + "\"");
                        }
                        else
                        {
                            RunApp(Environment.ExpandEnvironmentVariables(@"%windir%\System32\regsvr32.exe"), (silent ? "/s /u \"" : "/u \"") + comShellEtxDLL32 + "\"");
                        }
                    }
                }
            }
        ...
        public CSScriptInstaller(bool quiet, bool update)
        {
            ...
            else if (string.Compare(GetExecutingEngineDir(), GetEnvironmentVariable("CSSCRIPT_DIR"), true) != 0 && !preventMigration)
            {
                    ...
                    "CS-Script Configuration", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button2))
                {
                    ...
                    bool doShellExt = IsComShellExtInstalled();
                    UnInstall();
                    Install(doShellExt);

                    if (!quiet) SplashScreen.HideSplash();

                    if (!quiet)
                        MessageBox.Show("The CS-Script has been activated.\n" +
                                        "Please review the settings in the \"Runtime options\" tab as in result of the \"settings migration\" " +
                                        "they may now contain new defaults or invalid values (etc. absolute paths).", "CS-Script Configuration");
        ...
        private object GetKeyValue(string name, string valueName)
        {
        ...
        private void SetKeyValue(string keyName, string name, object value)
        {
        ...
        public string[] AvailableCLRVersions
        {
            get
            {
                ...
                retval.Add("<default>");
                foreach (string dir in Directory.GetDirectories(Path.Combine(Environment.GetEnvironmentVariable("windir"), @"Microsoft.NET\Framework")))
                {
