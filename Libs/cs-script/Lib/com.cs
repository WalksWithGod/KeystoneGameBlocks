	...
	class Script
	{
		...
		static public void Main(string[] args)
		{
			...
			try
			{
				...
				{
					if (File.Exists(Path.Combine(Path.GetDirectoryName(CSSEnvironment.PrimaryScriptFile), input)))
						input = Path.Combine(Path.GetDirectoryName(CSSEnvironment.PrimaryScriptFile), input);
				}
				else
