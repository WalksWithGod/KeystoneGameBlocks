//css_dbg /t:winexe, /args:BookPages.xap;
using System;
...
class Script
{
    const string usage =
            ...
            " /exe - generates self contained executable for executes silverlight XAP.\n";
    ...
    public static void GenerateExecutable(string xapFile)
    {
        ...
        try
        {
            ...
            using (StreamWriter sw = new StreamWriter(xapSource))
            {
                ...
                sw.WriteLine("//css_inc " + CSSEnvironment.PrimaryScriptFile + ";");
            }
...
public class SLViewer : Form
{
    ...
    void Init()
    {
        ...
        browser.Url = new Uri("http://localhost:" + InitWebServer());
    }
