...
Program Release Date:
  07/09/2007
Program Purpose:
  ZipForge.NET is an advanced ZIP compression library. 
  With this toolkit you can easily add archive functionality to your projects. 
Target Environment:
...
ZipForge.NET is an advanced ZIP compression library. With this toolkit you can easily add archive functionality to your projects. 

ZipForge.NET includes our new unique techonology, a transaction system. This innovative solution gives you a fast and easy way of updating archive files providing data integrity like a reliable database system. 

ZipForge.NET Personal is free for personal use. Any company that uses ZipForge.NET in its projects must order ZipForge.NET Pro. 
...
1) Make sure that all copies of Visual Studio are currently 
   closed and not running on the target system. Also, if you are 
   replacing an existing version of ZipForge.NET, please remove all files and
   the package of the prior version before running the new setup program.

2) Unpack zip archive containing ZipForge.NET into any directory. 
