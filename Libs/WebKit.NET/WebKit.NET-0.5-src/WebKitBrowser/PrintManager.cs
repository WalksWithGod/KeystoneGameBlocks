...
//
//                WebKit.Interop._RemotableHandle t = new _RemotableHandle();
//                t.fContext = 0;
//                
//                _owner.Invoke(new MethodInvoker(delegate() {
//                    _webFramePrivate.setInPrintingMode(1, ref _hDC);
//                }));
//
//                _nPages = (uint)_owner.Invoke(
//                    new GetPrintedPageCountDelegate(delegate() {
//                    return _webFramePrivate.getPrintedPageCount(ref _hDC);
//                }));
//
//                _page = 1;
//            }
//
//            _owner.Invoke(new MethodInvoker(delegate() {
//                _webFramePrivate.spoolPages(ref _hDC, _page, _page, IntPtr.Zero);
//            }));
//
//            ++_page;
//            if (_page <= _nPages)
