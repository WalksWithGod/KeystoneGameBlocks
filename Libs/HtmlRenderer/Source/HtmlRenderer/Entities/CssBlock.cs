...
namespace HtmlRenderer.Entities
{
    ...
    public sealed class CssBlock
    {
        ...
        /// TODO: properties seem are selectable based on pseudoclass matches 
        /// TODO: these psuedoclass selectors are also hierarchical and can be inherited
        /// TODO: i think then that these properties should include in their "key" the psuedoclasses
        /// or we have to somehow add them to selectors.
        /// Thing is this, normally, selectors are processed in real time during rendering
        /// traversal.  Thus every change in state of any part of the page requires a full
        /// repaint.
