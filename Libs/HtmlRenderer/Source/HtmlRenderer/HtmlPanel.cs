...
namespace HtmlRenderer
{
    ...
    public class HtmlPanel : ScrollableControl
    {
        ...
        public HtmlPanel()
        {
            ...
            _htmlContainer.LinkMouseEnter += OnLinkMouseEnter; // Hypnotron Oct.28.2013 - Added
            _htmlContainer.LinkMouseLeave += OnLinkMouseLeave; // Hypnotron Oct.28.2013 - Added
        ...
        /// Allows canceling the execution of the link.
        /// </summary>
        public event EventHandler<HtmlLinkClickedEventArgs> LinkClicked;  // :Active

        /// <summary>
        /// Raised when the mouse enters a link in the html.<br/>
        /// </summary>
        public event EventHandler<HtmlLinkClickedEventArgs> LinkMouseEnter; // Hypnotron Oct.28.2013 - Added Event // :Hover
        
        /// <summary>
        /// Raised when the mouse leaves a link in the html.<br/>
        /// </summary>
        public event EventHandler<HtmlLinkClickedEventArgs> LinkMouseLeave; // Hypnotron Oct.28.2013 - Added Event
        ...
        public override string Text
        {
            ...
            set
            {
                ...
                if (!IsDisposed)
                {
                    ...
                    _htmlContainer.SetHtml(base.Text, _baseCssData);
                    PerformLayout(); 
                    Invalidate();
                }
            }
        ...
        /// <summary>
        /// Allows setting of new HTML with option to avoid changing of the VerticalScroll.Value.
        /// This way we can modify a tiny portion of a webpage (eg to udpate text of a counter) and create the illusion that
        /// only that tiny part of the page is being updated in real time.  Combined with double buffering, there is 0 flicker.
        /// </summary>
        /// <param name="html"></param>
        /// <param name="resetVerticalScroll"></param>
        public void SetHtml (string html, bool resetVerticalScroll)
        {
        	...
        	else 
        	{
        		...
        		if (!IsDisposed)
        		{
        			_htmlContainer.SetHtml (html, _baseCssData);
        			PerformLayout();
                    Invalidate();
        		}
        	}
