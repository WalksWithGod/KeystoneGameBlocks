...
namespace HtmlRenderer.Parse
{
    ...
    internal static class RegexParserUtils
    {
        ...
        /// <summary>
        /// Extracts CSS background-repeat from shorthand background property;  (repeat is default)
        /// </summary>
        public const string CssBackgroundRepeat = "(repeat|repeat-x|repeat-y|no-repeat|inherit)";
        
        /// <summary>
        /// Extracts CSS background-attachment from shorthand background property;  (scroll is default)
        /// </summary>
        public const string CssBackgroundAttachment = "(scroll|fixed|local)";
        
        /// <summary>
        /// Extracts CSS background-position from shorthand background property;  (center is default)
        /// </summary>
        public const string CssBackgroundPosition = "(left top|left center|left bottom|right top|right center|right bottom|center top|center center|center bottom)";
