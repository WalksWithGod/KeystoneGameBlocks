...
{
    public partial class ColorTypeEditor : System.Drawing.Design.UITypeEditor
    {
        ...
        {
            if (ColorChanged != null && sender != this) ColorChanged(this, e);
        }
        ...
        // https://stackoverflow.com/questions/65820024/how-to-custom-draw-a-griditem-in-propertygrid
        ...
        public override object EditValue(System.ComponentModel.ITypeDescriptorContext context, System.IServiceProvider provider, object value)
        {
            ...
            //      return value;
            Keystone.Types.Color c = (Keystone.Types.Color)value;
            ...
            if (edSvc != null)
            {
                ...
                ColorPicker.ColorPickerCtrl angleControl = new ColorPicker.ColorPickerCtrl();
                angleControl.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                edSvc.DropDownControl(angleControl);

                // NOTE: Keystone.Types.Color uses the clas attribute [TypeConverter(typeof(Keystone.TypeConverters.ColorConverter))]
                c =  new Keystone.Types.Color(angleControl.SelectedColor.R, angleControl.SelectedColor.G, angleControl.SelectedColor.B, angleControl.SelectedColor.A);
                value = c;
               // System.Drawing.Color tmp = Color.FromArgb(c.ToInt32()); // new System.Drawing.Color();
               // value = tmp;
        ...
        {
            base.PaintValue(e);
           // e.Graphics.FillRectangle(new SolidBrush(e.Value), 
    ...
    public class AngleEditorTestControl : System.Windows.Forms.UserControl
    {
        ...
        [EditorAttribute(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor))]
        public double Angle
        {
            get
            { return int_angle; }
