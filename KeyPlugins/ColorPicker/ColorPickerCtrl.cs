...
namespace KeyPlugins.ColorPicker
{
    ...
    public partial class ColorPickerCtrl : UserControl
	{
        ...
        // NOTE: the font of this control needs to be Microsoft Sans Serif, 8.25pt or the scaling of the child controls will be off.
        //       By default when you place the control on a form, it inherits the font of that form so be aware.
