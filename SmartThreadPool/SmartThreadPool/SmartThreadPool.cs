...
namespace Amib.Threading
{
	...
	public class SmartThreadPool : IWorkItemsGroup, IDisposable
	{
		...
		public IWorkItemResult QueueWorkItem(WorkItemCallback callback, object state)
		{
			...
			Enqueue(workItem);
			return workItem.GetWorkItemResult(); // .GetWorkItemResult is just a property
		}
        ...
        public IWorkItemsGroup CreateWorkItemsGroup (int concurrency, STPStartInfo startInfo)
        {
            IWorkItemsGroup workItemsGroup = new WorkItemsGroup(this, concurrency, startInfo);
			return workItemsGroup;
        }

        /// <summary>
        /// Concurrency is how many active threads.  If a thread blocks on IO, and concurrency
        /// is set to 1, then another thread will start IF max threads > 1.
        /// </summary>
