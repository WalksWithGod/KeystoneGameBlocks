...
namespace Amib.Threading.Internal
{
    ...
    public class WorkItem : IHasWorkItemPriority, IWorkItem
    {
            ...
            object state)
        {
            ...
            {
                _callerContext =
                    CallerThreadContext.Capture(_workItemInfo.UseCallerCallContext, _workItemInfo.UseCallerHttpContext);
            }
        ...
        private void ExecuteWorkItem()
        {
            ...
            {
                ctc =
                    CallerThreadContext.Capture(_callerContext.CapturedCallContext, _callerContext.CapturedHttpContext);
