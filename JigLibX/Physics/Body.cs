...
namespace JigLibX.Physics
{
    ...
    public partial class Body
    {
        ...
        internal Transform oldTransform;  // transform from previous physics update
        ...
        private Transform storedTransform; // transform from previous physics STEP (not same as previous physics update)
        ...
        private float inactiveTime;     // how long we've been still
        ...
        private const float VelMax = 100000.0f;
        private const float AngVelMax = 500.0f;
        ...
        static int idCounter; // todo: this seems kind of lame way to produce uniuque ID. hard to sychronize id's over network, does it need to be sychronized?  are they only needed locally? what re id's used for... i guess for 
        internal int ID;
        ...
        public void Initialize(float mass)
        {
            JigLibX.Geometry.PrimitiveProperties primitiveProperties =
                new JigLibX.Geometry.PrimitiveProperties(JigLibX.Geometry.PrimitiveProperties.MassDistributionEnum.Solid, JigLibX.Geometry.PrimitiveProperties.MassTypeEnum.Density, mass);
        ...
        public void GetOrientation(out float m11, out float m12, out float m13,
        ...
        {
            MoveTo(new Vector3(x, y, z), Orientation);
        }
        /// <summary>
        ...
        public void UpdatePositionWithAux(float dt)
        {
            ...
            if (this.CollisionSkin != null)
                ...
                //// MPJ - keystone entity update
                //_entity.Translation = transform.Position;
                //_entity.Rotation = transform.Orientation;
