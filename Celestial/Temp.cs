...
namespace Celestial
{
    class Temp
    {
        ...
        // page 49
        // a decomal datatype would definetly be large enough as it can hold over 8.40646793e12 light years!
        ...
        private float _mass = 1.98892E+30F; // in kilograms  Sun = 1.98892 × 10^30 kilograms.  Might want to make this kilotons then? No.  Lets do all our conversions via functions and formatting.
        ...
        private decimal decLightYear = 9424667196000000; // meters 1 LY uses 16 significant digits.  9,424,667,196,000,000
        ...
        private float earthDistanceToSunSingle = 1.495979E+11F;  // ~500 light seconds away (8.33 light minutes)
        private double earthDistanceToSun = 149597892000.0D; //meters (1AU)  ~63,000 AU = 1LY   // ~150000000000F;// 150 billion meters // note: earth loks like tiny dot from 4billion miles away http://en.wikipedia.org/wiki/Image:PaleBlueDot.jpg
        ...
        // So WE DO STILL NEED TO USE the floating origin.  
        private double plutoDistance = 5900000000000.2D;  //meters note if you try to store that in a single, you lose the .2 and it turns to 5.9E+13!  39.5AU
        //                             5909116734000
        private float plutoDistanceSingle = 5.9E+13F; // average 5.9 billion kilometers or 5.9 trillion meters. (light takes 5.5 hours to reach pluto) here with doubles, we can use meters to have a solar system with a radius of pluto's distance
        ...
        private double dblLightYear = 9.46053E+15D; // 9460530000000000 ' meters.   NOTE: Here we are at the bounds of the precision for a system
