...
namespace Keystone
{
    ...
    {
        private Vector2f p0; // Begin point of the line
        private Vector2f p1; // End point of the line
        ...
        public RoundLine(Vector2f p0, Vector2f p1)
        {
            this.p0 = p0;
            this.p1 = p1;
            RecalcRhoTheta();
    ...
    {
        public Disc(Vector2f p) : base(p, p) { }
    ...
    {
        public Vector3d pos;
        public Vector2f rhoTheta;
        public Vector2f scaleTrans;
        public float index;

        public RoundLineVertex(Vector3d pos, Vector2f norm, Vector2f tex, float index)
        {
            this.pos = pos;
            this.rhoTheta = norm;
            this.scaleTrans = tex;
        ...
        public readonly static VertexDeclaration VertexDeclaration = new VertexDeclaration
            (
                ...
                new VertexElement(12, VertexElementFormat.Vector2f, VertexElementUsage.Normal, 0),
                new VertexElement(20, VertexElementFormat.Vector2f, VertexElementUsage.TextureCoordinate, 0),
    ...
    class RoundLineManager
    {
        ...
        private void CreateRoundLineMesh()
        {
            ...
            for (int instance = 0; instance < numInstances; instance++)
            {
                ...
                iVertex = iv;
                tri[iv++] = new RoundLineVertex(new Vector3d(0.0f, -1.0f, 0), new Vector2f(1, threePi2), new Vector2f(0, 0), instance);
                tri[iv++] = new RoundLineVertex(new Vector3d(0.0f, -1.0f, 0), new Vector2f(1, threePi2), new Vector2f(0, 1), instance);
                tri[iv++] = new RoundLineVertex(new Vector3d(0.0f, 0.0f, 0), new Vector2f(0, threePi2), new Vector2f(0, 1), instance);
                tri[iv++] = new RoundLineVertex(new Vector3d(0.0f, 0.0f, 0), new Vector2f(0, threePi2), new Vector2f(0, 0), instance);
                tri[iv++] = new RoundLineVertex(new Vector3d(0.0f, 0.0f, 0), new Vector2f(0, pi2), new Vector2f(0, 1), instance);
                tri[iv++] = new RoundLineVertex(new Vector3d(0.0f, 0.0f, 0), new Vector2f(0, pi2), new Vector2f(0, 0), instance);
                tri[iv++] = new RoundLineVertex(new Vector3d(0.0f, 1.0f, 0), new Vector2f(1, pi2), new Vector2f(0, 1), instance);
                tri[iv++] = new RoundLineVertex(new Vector3d(0.0f, 1.0f, 0), new Vector2f(1, pi2), new Vector2f(0, 0), instance);
                ...
                for (int i = 0; i < primsPerCap + 1; i++)
                {
                    ...
                    tri[iVertex + 0] = new RoundLineVertex(new Vector3d(0, 0, 0), new Vector2f(0, theta1), new Vector2f(0, 0), instance);

                    // odd-numbered indices are at the perimeter of the halfdisc
                    float x = (float)Math.Cos(theta0);
                    float y = (float)Math.Sin(theta0);
                    tri[iVertex + 1] = new RoundLineVertex(new Vector3d(x, y, 0), new Vector2f(1, theta0), new Vector2f(1, 0), instance);
                ...
                for (int i = 0; i < primsPerCap + 1; i++)
                {
                    ...
                    // even-numbered indices are at the center of the halfdisc
                    tri[iVertex + 0] = new RoundLineVertex(new Vector3d(0, 0, 0), new Vector2f(0, theta1), new Vector2f(0, 1), instance);

                    // odd-numbered indices are at the perimeter of the halfdisc
                    float x = (float)Math.Cos(theta0);
                    float y = (float)Math.Sin(theta0);
                    tri[iVertex + 1] = new RoundLineVertex(new Vector3d(x, y, 0), new Vector2f(1, theta0), new Vector2f(1, 1), instance);
