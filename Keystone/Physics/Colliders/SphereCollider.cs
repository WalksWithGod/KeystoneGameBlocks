...
{
    public class SphereCollider : Node
    {
        bool mIsTrigger;
        double mRadius;
        Vector3d mCenter;
        ...
        internal SphereCollider(string id) : base(id)
        {
            Shareable = false;
        }
        ...
        public override Settings.PropertySpec[] GetProperties(bool specOnly)
        {
            ...
            properties[2] = new Settings.PropertySpec("center", typeof(Vector3d).Name);
            ...
            if (!specOnly)
            {
                ...
                properties[2].DefaultValue = mCenter;
            }
