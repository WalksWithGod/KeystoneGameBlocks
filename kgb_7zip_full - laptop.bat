...
"c:\Program Files\7-zip\7z.exe" a -t7z C:\Users\Michael\backups\%DATE:~-4%-%DATE:~4,2%-%DATE:~7,2%_KGB_FULL.7z "C:\Users\Michael\projects\KeystoneGameBlocks\" -mmt -p%pass% -mhe -xr!pool\
